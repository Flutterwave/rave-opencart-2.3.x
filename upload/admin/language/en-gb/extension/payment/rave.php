...
$_['text_rave'] = '<a target="_BLANK" href="https://www.rave.flutterwave.com"><img src="view/image/payment/rave.svg" alt="Rave" title="Rave" style="border: 1px solid #cccccc;" /></a>';
$_['text_pay'] = 'Pay';
...
$_['entry_payment_plan'] = 'Payment Plan ID';
...
$_['help_payment_plan'] = 'Input payment plan id to subsribe customers to the plan';
